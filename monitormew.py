...
url = "https://cartesplus.fr/produit/coffret-ultra-premium-mew-ev3-5/"
...
while True:
    ...
    if current_content:
        ...
        if current_md5 != initial_md5:
            ...
            send_discord_notification("La page a été modifiée **N'OUBLIEZ PAS LE CODE MATTISPOKEMON POUR 5% DE RABAIS** " + url)
